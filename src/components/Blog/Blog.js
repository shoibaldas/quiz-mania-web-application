...
const Blog = () => {
    return (
        <div className='md:mt-8 flex flex-col justify-center items-center gap-4'>
            ...
            <div
                className="max-w-screen-md rounded-lg  shadow-lg drop-shadow-2xl bg-white">
                <div className="p-5">
                    <a href="/">
                        <h5 className="mb-2 text-2xl font-bold tracking-tight text-violet-900"> How does context API works?</h5>
                    </a>
                    <p className="mb-3 font-normal text-md text-gray-700 text-justify">An efficient approach for a React project to create global variables that can be passed around is using the React Context API. The alternative to "prop drilling" or passing along props from grandma to child to parent and so on is to do this. Instead of delivering information down a chain of props, it enables data to be sent directly from parent to children nested far down the component tree. <br />
            ...
            <div
                className="max-w-screen-md bg-white rounded-lg shadow-lg drop-shadow-2xl mb-6">
                <div className="p-5">
                    <a href="/">
                        <h5 className="mb-2 text-2xl font-bold tracking-tight text-violet-900">What is useRef hook?</h5>
                    </a>
                    <p className="mb-3 font-normal text-gray-700 text-justify">You may maintain values between renderings by using the useRef Hook.A changeable value that does not require a re-render when modified can be stored there.It may be used to get immediate access to a DOM element. <br />
